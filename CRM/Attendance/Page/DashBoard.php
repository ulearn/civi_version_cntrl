...
require_once 'CRM/Attendance/Page/DashBoard.php';

/**
 * Page for displaying list of Payment-Instrument
 */
class CRM_Attendance_Page_DashBoard extends CRM_Core_Page 
{
    /** 
    ...
    function run( ) { 
      ...
      // $this->preProcess( );
        $controller =& new CRM_Core_Controller_Simple( 'CRM_Attendance_Form_Search', ts('Member'), null ); 
